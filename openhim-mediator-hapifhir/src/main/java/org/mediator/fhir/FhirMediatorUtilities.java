            ...
            else
            {
                if(oPractitioner.getIdentifier().size()>0)
                {
                    ...
                    for (Practitioner cleanedPractitioner: cleanedList)
                    {
                        ...
                        {
                            List<Identifier> practitionerListIdentifier=oPractitioner.getIdentifier();
                            List<Identifier> cleanedListIdentifier=cleanedPractitioner.getIdentifier();
                            for (Identifier practitionerIdentifier:practitionerListIdentifier)
                            {
                                for (Identifier cleanedIdentifier:cleanedListIdentifier)
                                {
